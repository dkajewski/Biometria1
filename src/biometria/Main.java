...
public class Main {
	...
	private static final int[][] naro¿niki = { { -1, -1, -1 }, { 2, 2, 2 }, { -1, -1, -1 } };
	private static final int[][] _prewitt = { { -1, 0, 1 }, { -1, 0, 1 }, { -1, 0, 1 } };
	private static final int[][] _laplace = { { 0, -1, 0 }, { -1, 4, -1 }, { 0, -1, 0 } };
	private static final int[][] _sobel = { { 1, 2, 1 }, { 0, 0, 0 }, { -1, -2, -1 } };
	private static final int[][] _dolnop = { { 1, 1, 1 }, { 1, 2, 1 }, { 1, 1, 1 } };
	...
	public static void main(String[] args) {
		...
		JButton naro¿nik = new JButton("Naro¿niki");
		naro¿nik.setBounds(160, 475, 100, 20);

		JButton prewitt = new JButton("Prewitt");
		prewitt.setBounds(160, 495, 100, 20);

		JButton laplace = new JButton("Laplace");
		laplace.setBounds(260, 495, 100, 20);

		JButton sobel = new JButton("Sobel");
		sobel.setBounds(60, 495, 100, 20);
		
		JButton dolnop = new JButton("dolnop..");
		dolnop.setBounds(260, 475, 100, 20);
		...
		konwol.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				int[][] kernel = {
						{ Integer.parseInt(_1.getText()), Integer.parseInt(_2.getText()),
								Integer.parseInt(_3.getText()) },
						{ Integer.parseInt(_4.getText()), Integer.parseInt(_5.getText()),
								Integer.parseInt(_6.getText()) },
						{ Integer.parseInt(_7.getText()), Integer.parseInt(_8.getText()),
								Integer.parseInt(_9.getText()) } };
				Konwolucja(kernel);
			}
		});

		naro¿nik.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				_1.setText(naro¿niki[0][0] + "");
				_2.setText(naro¿niki[0][1] + "");
				_3.setText(naro¿niki[0][2] + "");
				_4.setText(naro¿niki[1][0] + "");
				_5.setText(naro¿niki[1][1] + "");
				_6.setText(naro¿niki[1][2] + "");
				_7.setText(naro¿niki[2][0] + "");
				_8.setText(naro¿niki[2][1] + "");
				_9.setText(naro¿niki[2][2] + "");

				Konwolucja(naro¿niki);
			}
		});
		...
		prewitt.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				_1.setText(_prewitt[0][0] + "");
				_2.setText(_prewitt[0][1] + "");
				_3.setText(_prewitt[0][2] + "");
				_4.setText(_prewitt[1][0] + "");
				_5.setText(_prewitt[1][1] + "");
				_6.setText(_prewitt[1][2] + "");
				_7.setText(_prewitt[2][0] + "");
				_8.setText(_prewitt[2][1] + "");
				_9.setText(_prewitt[2][2] + "");
		...
		laplace.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				_1.setText(_laplace[0][0] + "");
				_2.setText(_laplace[0][1] + "");
				_3.setText(_laplace[0][2] + "");
				_4.setText(_laplace[1][0] + "");
				_5.setText(_laplace[1][1] + "");
				_6.setText(_laplace[1][2] + "");
				_7.setText(_laplace[2][0] + "");
				_8.setText(_laplace[2][1] + "");
				_9.setText(_laplace[2][2] + "");
		...
		sobel.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				_1.setText(_sobel[0][0] + "");
				_2.setText(_sobel[0][1] + "");
				_3.setText(_sobel[0][2] + "");
				_4.setText(_sobel[1][0] + "");
				_5.setText(_sobel[1][1] + "");
				_6.setText(_sobel[1][2] + "");
				_7.setText(_sobel[2][0] + "");
				_8.setText(_sobel[2][1] + "");
				_9.setText(_sobel[2][2] + "");

				Konwolucja(_sobel);
			}
		});
		
		dolnop.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				_1.setText(_dolnop[0][0] + "");
				_2.setText(_dolnop[0][1] + "");
				_3.setText(_dolnop[0][2] + "");
				_4.setText(_dolnop[1][0] + "");
				_5.setText(_dolnop[1][1] + "");
				_6.setText(_dolnop[1][2] + "");
				_7.setText(_dolnop[2][0] + "");
				_8.setText(_dolnop[2][1] + "");
				_9.setText(_dolnop[2][2] + "");
		...
		rightPanel.add(naro¿nik);
		rightPanel.add(prewitt);
		rightPanel.add(laplace);
		rightPanel.add(sobel);
		rightPanel.add(dolnop);
		panel.add(leftPanel);
	...
	private static void getPixelsValues() {
		...
		for (int x = 0; x < img.getWidth(); x++) {
			for (int y = 0; y < img.getHeight(); y++) {
				...
				mean = (double) ((((((((clr & 0x00ff0000) >> 16)) * 1.0) / 2) + ((((clr & 0x0000ff00) >> 8) * 1.0) / 2)
						+ (((clr & 0x000000ff) * 1.0) / 2))) / 3);
				meanValues[(int) mean]++;
			}
		}
	}
	...
	public static void Kuwahara() {
		...
		double rm[] = new double[4], gm[] = new double[4], bm[] = new double[4]; // wartosci
																					// srednie
